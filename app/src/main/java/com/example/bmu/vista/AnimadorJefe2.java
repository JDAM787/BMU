...
public class AnimadorJefe2 {
    ...
    private static final String FOLDER = "personajes/jefes/jefe2/";

    public AnimadorJefe2() {
        ...
        animPunch = crearAnimacion(0.15f, Animation.PlayMode.NORMAL, "golpeando/golpea1.png", "golpeando/golpea2.png");
    ...
    private Animation<TextureRegion> crearAnimacion(float duracionFrame, Animation.PlayMode playMode, String... rutasRelativas) {
        ...
        for (String ruta : rutasRelativas) {
            try {
                ...
                System.out.println("AnimadorJefe2: No se pudo cargar: " + FOLDER + ruta);
            }
        }
        if (frames.size == 0) {
