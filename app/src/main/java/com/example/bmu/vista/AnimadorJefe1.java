...
public class AnimadorJefe1 {
    ...
    private static final String FOLDER = "personajes/jefes/jefe1/";

    public AnimadorJefe1() {
        ...
        animIdle = animWalk; // No hay animación de quieto, usa caminando por defecto
        ...
        animDead = crearAnimacion(0.15f, Animation.PlayMode.NORMAL, "muerto/muerto.png");
    }
    ...
    private Animation<TextureRegion> crearAnimacion(float duracionFrame, Animation.PlayMode playMode, String... rutasRelativas) {
        ...
        for (String ruta : rutasRelativas) {
            try {
                ...
                System.out.println("AnimadorJefe1: No se pudo cargar: " + FOLDER + ruta);
            }
        }
        if (frames.size == 0) {
